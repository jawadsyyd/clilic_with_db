    ...
    <div class="container-fluid my-3 pt-5 rounded p-3" style="background-color: rgb(188, 227, 226);">
        <div class="row">
            <div class="col-4"><a class="navbar-brand" href="#">
                    ...
                    <span class="fw-semibold">Gomedic</span>
                </a> <br>
                <p class="mt-3">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Culpa maiores sunt velit
                    provident
                    aperiam eos.</p>
            </div>
            <div class="col-1"></div>
            <div class="col-3">
                <span class="fw-semibold">Information</span><br>
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="#"><svg xmlns="http://www.w3.org/2000/svg"
                            ...
                            </svg> <span>Gomedic Building, Exapmle Street, Tripoli, Lebanon</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                            ...
                            </svg> <span>hello@gomedic.com</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
